	...
	public String reformatData() {
		...
		try {
	        ...
	        for (int i = 0; i < jsonArray.length(); i++) {
	            ...
	            fieldsObject.put("member_count", dataObject.isNull("member_count") ? null : dataObject.getInt("member_count"));
		        ...
		        POSTRequest("appfpkYiYDZtMWJhA", "tbl4FG2B4nb6RwtWI", "patJOGkmzGUONSJVC.1e139f03d8fc3789fa64c266896a4a32fd875c90d0c83e895e28e49a44ed89b7", resData);
	        }
